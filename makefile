...
#(givendata depends only on initialize and utilities)
# givendata.o: initialize.cxx utilities.cpp 
# 	$(COMPILE.cc) $(OUTPUT_OPTION) $<	#(dont change this line)